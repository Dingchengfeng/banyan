package com.standard.banyan.simulation.mqtt;

import com.standard.banyan.simulation.mqtt.topic.SubscribeTopic;
...
public class MessageCallback implements MqttCallback {
    ...
    public void connectComplete(boolean reconnect, String serverUri) {
        ...
        defaultMqttClient.subscribe(SubscribeTopic.ORDER.getTopicFilter(),SubscribeTopic.ORDER.getQos());
        defaultMqttClient.subscribe(SubscribeTopic.INSTANT_ACTIONS.getTopicFilter(),SubscribeTopic.INSTANT_ACTIONS.getQos());
    }
