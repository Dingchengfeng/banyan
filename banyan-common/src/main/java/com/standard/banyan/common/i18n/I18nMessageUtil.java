...
public class I18nMessageUtil {
    ...
    private static final String PATH_PARENT = "classpath:i18n/messages/messages_";
    ...
    public static String getMessage(String message, String defaultMessage) throws IOException {
        String language = LanguageEnum.getLanguageType(LocaleContextHolder.getLocale().toString());
        return getMessage(language, message, defaultMessage);
    }
